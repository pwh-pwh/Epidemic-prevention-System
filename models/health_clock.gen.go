...
type HealthClock struct {
	...
	HealthType  int32                 `gorm:"column:health_type;type:int(1)" json:"healthType"`                       // 健康状况
	Temperature float32               `gorm:"column:temperature;type:float(6,1)" json:"temperature"`                  // 温度
	MiddleHigh  int32                 `gorm:"column:middle_high;type:int(1)" json:"middleHigh"`                       // 中高风险
	Diagnosis   int32                 `gorm:"column:diagnosis;type:int(1)" json:"diagnosis"`                          // 确诊
	ReturnInfo  int32                 `gorm:"column:return_info;type:int(1)" json:"returnInfo"`                       // 境外返回
	...
	DeptID      int32                 `gorm:"column:dept_id;type:int(11)" json:"deptId"`                              // 部门id
