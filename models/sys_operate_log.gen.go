...
type SysOperateLog struct {
	...
	BusinessType  string    `gorm:"column:business_type;type:varchar(50)" json:"business_type"`        // 业务类型
	Method        string    `gorm:"column:method;type:varchar(100)" json:"method"`                     // 方法名称
	RequestMethod string    `gorm:"column:request_method;type:varchar(10)" json:"request_method"`      // 请求方式
	...
	OperLocation  string    `gorm:"column:oper_location;type:varchar(255)" json:"oper_location"`       // 操作地点
	OperParam     string    `gorm:"column:oper_param;type:varchar(2000)" json:"oper_param"`            // 请求参数
